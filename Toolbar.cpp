...
static ToolbarButtonInfo gToolbarButtons[] = {
    ...
    {TbIcon::Highlight, CmdCreateAnnotHighlight, _TRN("Highlight")}, // info text
    {TbIcon::Underline, CmdCreateAnnotUnderline, _TRN("Underline")}, // info text
    {TbIcon::Squiggly, CmdCreateAnnotSquiggly, _TRN("Squiggly")},   // info text
    {TbIcon::BBox, CmdCreateAnnotBBox, _TRN("Text Box")},           // info text
};
...
void SetToolbarInfoText(MainWindow* win, const WCHAR* s) {
    ...
    TbGetRect(win->hwndToolbar, CmdCreateAnnotBBox, &r);        
